...
const NAVBAR_TOKENS = {
    active: {
        ...
        radius: 16,
        shadow: '0 10px 40px rgba(0, 0, 0, 0.35), inset 0 1px 0 rgba(255, 255, 255, 0.06)',
        scrollShadow: '0 14px 44px rgba(0, 0, 0, 0.38), inset 0 1px 0 rgba(255, 255, 255, 0.06)',
        idleShadow: '0 8px 28px rgba(0, 0, 0, 0.24), inset 0 1px 0 rgba(255, 255, 255, 0.04)',
        hoverShadow: '0 12px 42px rgba(0, 0, 0, 0.36), inset 0 1px 0 rgba(255, 255, 255, 0.06)',
        paddingX: 32,
        paddingY: 10,
        top: 20,
        widthClass: 'w-full',
