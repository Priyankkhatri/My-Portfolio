...
export const projects = [
    ...
    },
    {
        ...
        description: 'Small browser games (snake, arcade, etc.) built to practice JS game loops and DOM management. Includes Snake Game, Tic Tac Toe (with Minimax AI), Memory Match, and Typing Speed Test.',
